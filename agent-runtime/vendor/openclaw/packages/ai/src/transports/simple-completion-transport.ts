...
// ARJUN sovereign build: prepareCodexSimpleTransportModel is removed. It
// existed to route openai-chatgpt-responses models through ChatGPT's
// backend-api with resolved request auth -- a vendor endpoint, and an API
// this build no longer supports.
